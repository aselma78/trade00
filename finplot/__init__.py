...
if dark:
    legend_border_color = '#ffffffdd'
    legend_fill_color   = '#aaaaaa55'
    legend_text_color   = '#dddddd66'
    soft_colors = ['#1f77b4', '#ff7f0e', '#2ca02c', '#d62728', '#9467bd', '#8c564b', '#e377c2', '#7f7f7f', '#bcbd22', '#17becf']
    hard_colors = ['#dddddd', '#772211', '#dddd66', '#555555', '#ff22cc', '#ffcc00']
    foreground = '#eeeeee'
    background = '#222222'
    ...
    odd_plot_background = '#0f0f0f'
    band_color = '#ddbbaa'
    cross_hair_color = '#dddddd77'
    draw_line_color = '#ffffff'
